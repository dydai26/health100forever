...
const ViberIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const Contact: React.FC = () => {
  ...
  return (
    <div className="contact-section" id="contact">
      <div className="contact-inner">
        ...
        <div>
          <div className="contact-channels">
            <a href="mailto:health100cl@gmail.com" className="contact-channel">
              <div className="channel-icon">
                <EmailIcon style={{ width: 22, height: 22 }} />
              </div>
              <div>
                <div className="channel-label">Email</div>
                <div className="channel-value">health100cl@gmail.com</div>
              </div>
            </a>
            <a href="viber://chat?number=%2B380500506695" className="contact-channel">
              <div className="channel-icon">
                <ViberIcon style={{ width: 22, height: 22 }} />
              </div>
              <div>
                <div className="channel-label">Viber</div>
                <div className="channel-value">+38 050 050 66 95</div>
              </div>
            </a>
            <a
              href="https://t.me/ABRAM_GOLDENBERG"
              target="_blank"
              rel="noopener noreferrer"
              className="contact-channel"
            >
              <div className="channel-icon">
                <TelegramIcon style={{ width: 22, height: 22 }} />
              </div>
              <div>
                <div className="channel-label">Telegram</div>
                <div className="channel-value">@ABRAM_GOLDENBERG</div>
              </div>
            </a>
          </div>
        </div>
      ...
      {/* New bottom highlighted info block */}
